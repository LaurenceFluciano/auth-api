import { TOffsetPagination } from "src/share/base/base.pagination";
...
export class FindUserUseCase 
{
    ...
    async findAll(pagination: TOffsetPagination): Promise<Either<UseCaseException,ResponseUserDto[]>>
    {
    ...
    async findOneById(id: Id): Promise<Either<UseCaseException,ResponseUserDto>>
    {
    ...
    async findByCredential(email: string, projectKey: string): Promise<Either<UseCaseException,ResponseUserDto>>
    {
